...
import (
	...
	"github.com/NPScProject/NPSc/conf"
	vCore "github.com/NPScProject/NPSc/core"
	"github.com/NPScProject/NPSc/limiter"
	"github.com/NPScProject/NPSc/node"
...
func init() {
	serverCommand.PersistentFlags().
		StringVarP(&config, "config", "c",
			"/etc/NPSc/config.json", "config file path")
	serverCommand.PersistentFlags().
