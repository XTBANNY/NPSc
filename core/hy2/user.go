...
import (
	...
	"github.com/NPScProject/NPSc/api/panel"
	"github.com/NPScProject/NPSc/common/counter"
	vCore "github.com/NPScProject/NPSc/core"
	"github.com/apernet/hysteria/core/v2/server"
)

var _ server.Authenticator = &NPSc{}
...
func (v *NPSc) Authenticate(addr net.Addr, auth string, tx uint64) (ok bool, id string) {
	v.mutex.RLock()
